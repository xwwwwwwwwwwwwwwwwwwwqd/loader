...
-- AncesHub.BackgroundFrame.Side.DraggablePart.Title
Ancestral["20"] = Instance.new("TextLabel", Ancestral["1c"]);
...
Ancestral["20"]["Visible"] = false;
Ancestral["20"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
Ancestral["20"]["Text"] = [[Discord: @x2zu]];
...
-- AncesHub.Floating.Folder.Title
Ancestral["d5"] = Instance.new("TextLabel", Ancestral["ce"]);
...
Ancestral["d5"]["Text"] = [[Discord: @x2zu]];
